...
GET         /investments                            List all (filter by userId, status, date range, paginate)
GET         /investments/statsGlobal                investment stats
GET         /investments/:id                        Get single investment
GET         /investments/user/:userId               All investments by a user
GET         /investments/user/:userId/stats         Stats for a specific user
PATCH       /investments/:id                        Update investment (amount, status, note)
